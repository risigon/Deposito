...
<html>
	<head>
		<title>Pesquisa Materiais</title>
	...
	<div class="row">
		<div class="col-md-12">
	      <label for="text" class="btn btn-info container">Pesquisar Material</label></br>
	    </div>
    </div>
    </br>
    </br>
    ...
    <div class="col-md-3" style="background-color:#ffcccc; border-radius: 5px;">
		<form enctype="multipart/form-data" name="cad" class="navbar-form" role="search" id="" action="estoque_id.php" method="post">
			...
			<input id="" class="btn btn-default" type="number" name="id" placeholder="código"  size="10" maxlength="4" required />
		...
		<span class="text-danger">Entradas Somadas</span></br>
